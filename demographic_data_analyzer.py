...
def calculate_demographic_data(print_data=True):
    ...
    non_percentage_higher = higher_education[higher_education['salary'] == '>50K']
    non_percentage_lower = lower_education[lower_education['salary'] == '>50K']
  
    higher_education_rich = round(len(non_percentage_higher) / len(higher_education) * 100, 1)
    lower_education_rich = round(len(non_percentage_lower) / len(lower_education) * 100, 1)
    ...
    occupation_counts = rich_people_india['occupation'].value_counts()
